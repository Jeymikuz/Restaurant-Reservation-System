...
namespace RestaurantDesktop.Data
{
    public class DataAccess
    {
        ...
        internal void UpdateTable(int TableID, int NumberOfChairs)
        {
            using (IDbConnection connection = new System.Data.SqlClient.SqlConnection(Helper.CnnVal("RestaurantDB")))
            {
                connection.Execute("exec dbo.UpdateTables @ID, @NumberOfChairs", new { ID = TableID, NumberOfChairs = NumberOfChairs });
            }
        }

        internal void DeleteTable(int TableID)
        {
            using (IDbConnection connection = new System.Data.SqlClient.SqlConnection(Helper.CnnVal("RestaurantDB")))
            {
